...
def air_cargo_p2() -> AirCargoProblem:
    ...
    # Not the location of cargo and planes
    # None of the cargo has been loaded into any plane.
    neg = [expr('At(C1, ATL)'),
           expr('At(C1, JFK)'),
           expr('At(C2, ATL)'),
           expr('At(C2, SFO)'),
    ...
    init = FluentState(pos, neg)
    # Goal: C1 to JFK and C2,C3 to SFO
    goal = [expr('At(C1, JFK)'),
            expr('At(C2, SFO)'),
            expr('At(C3, SFO)'),
            ]
...
def air_cargo_p3() -> AirCargoProblem:
    ...
    init = FluentState(pos, neg)
    # Goal: C1,C3 to JFK and C2,C4 to SFO
    goal = [expr('At(C1, JFK)'),
            expr('At(C2, SFO)'),
            expr('At(C3, JFK)'),
            expr('At(C4, SFO)'),
